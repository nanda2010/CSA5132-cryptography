...
// Function to find the shift value with the maximum frequency match int findShiftValue(int *frequency) { 
 int maxFrequency = 0; 
 int shift = 0; 
 int i; 
...
int main() { 
 ...
 fgets(ciphertext, sizeof(ciphertext), stdin);  int i; 
  
 int letterFrequency[ALPHABET_SIZE] = {0};  countLetterFrequency(ciphertext, letterFrequency);   
